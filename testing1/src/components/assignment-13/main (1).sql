...
create a table
 ...
 CREATE TABLE groups (
  ...
  groupsName varchar(50) ,

   groupsNumber varchar(50)

 );
 
 insert some values
 
 INSERT INTO groups VALUES (1,"goutham","team-1");
 
 INSERT INTO groups VALUES (2,"jagadeesh","team-2");
 
 INSERT INTO groups VALUES (3,"jason","team-3");
 
 INSERT INTO groups VALUES  (4,"venkat","team-4");
