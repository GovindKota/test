<template>
  <div>
    ...
    <b-button variant="danger" @click="fun">Get Data</b-button><br /><br />
    <b-input-group>
      <b-row><b-col cols-mc="12">
          <b-form-input id="filter-input" v-model="filter" type="search" placeholder="Type to Search"></b-form-input></b-col>
          </b-row>
...
export default {
  ...
  methods: {
    ...
    async fun() {
      ...
      var responce = await result.data;
